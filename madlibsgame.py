...
food1 = input("Enter another food: ")
shapes = input("Enter a shape: ")

print("Pizza was invented by a " + nationality + " chef named " + person)
print("To make a pizza, you need to take a lump of " + noun + " and make a thin, round " + adjective  +  noun)
